...
if(isset($_POST['update']))
{
    ...
    $alamat = $_POST['alamat'];
    $exe = mysqli_query($conn, "UPDATE pelanggan SET nama='$nama', no_telp='$no_telp', alamat='$alamat' WHERE id=$id");
    header("Location: ../operator/pelanggan.php");
}
?>
<?php
$id = $_GET['customerId'];
$exe = mysqli_query($conn, "SELECT * FROM pelanggan WHERE id=$id");
...
<html>
    ...
    <body>
        ...
        <form method="post" action="update_pelanggan.php" name="formupload">
            ...
            <div>
                ...
                <a href='../operator/pelanggan.php' style="border: 2px solid red; padding: 5px; border-radius: 5px; color: white; background-color: red; text-decoration: none;">Cancel</a>
            </div>
        </form>
    </body>
</html>
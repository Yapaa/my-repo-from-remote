...
<table border = "1" align = "center" width = "70%">
    ...
    <tr align="center">
        ...
        <td><?=$data['alamat']?></td>
        <td>
            <button  type="button" class="btn btn-secondary btn-lg"><a class="text-decoration-none text-white" href="../controller/delete.php?customerId=<?= $data['id']?>" >DELETE</a></button>
            <button  type="button" class="btn btn-secondary btn-md"><a class="text-decoration-none text-white" href="../controller/update_pelanggan.php?customerId=<?= $data['id']?>" >EDIT</a></button>
        </td>
    </tr>    
    <?php
    }
...
<form action="../controller/insert_pelanggan.php" method="post" align ="center">
    <table align="center">
        <tr>
            <td>Nama</td>
            <td>:</td>
